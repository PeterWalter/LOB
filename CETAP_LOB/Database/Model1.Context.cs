...
public partial class CETAPEntities : DbContext
{
    ...
    public virtual DbSet<BankEasypayRecord> BankEasypayRecords { get; set; }

    public virtual DbSet<Barcode> Barcodes { get; set; }

    public virtual DbSet<CharacterReplacement> CharacterReplacements { get; set; }

    public virtual DbSet<DisabledWriter> DisabledWriters { get; set; }

    public virtual DbSet<lst_Disability> lst_Disability { get; set; }

    public virtual DbSet<temp_WriterList> temp_WriterList { get; set; }

    public virtual DbSet<Domain> Domains { get; set; }

    public virtual DbSet<Itembank> Itembanks { get; set; }

    public virtual DbSet<Subdomain> Subdomains { get; set; }

    public virtual DbSet<Composit_bak> Composit_bak { get; set; }

    public virtual DbSet<CompoTest> CompoTests { get; set; }

    public virtual DbSet<LogisticsComposit> LogisticsComposits { get; set; }
