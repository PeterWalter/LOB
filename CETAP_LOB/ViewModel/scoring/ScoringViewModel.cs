...
namespace CETAP_LOB.ViewModel.scoring
{
  public class ScoringViewModel : ViewModelBase
  {
    ...
    public const string ALPropertyName = "AL";
    public const string QLPropertyName = "QL";
    ...
    private ObservableCollection<AL_Score> _al;
    private ObservableCollection<QL_Score> _ql;
    ...
    public ObservableCollection<AQL_Score> AQL
    {
      ...
      set
      {
        ...
        public ObservableCollection<AL_Score> AL
        {
            get
            {
                return _al;
            ...
            set
            {
                if (_al == value)
                    return;
                _al = value;
                RaisePropertyChanged("AL");
            }
        }
        public ObservableCollection<QL_Score> QL
        {
            get
            {
                return _ql;
    ...
    {
      string text;
      if (_service.GenerateCompositeForSessionPnP())
      {
