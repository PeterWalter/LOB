...
namespace CETAP_LOB.Model
{
    ...
    public class DataService : IDataService
    {
        ...
        private ObservableCollection<AL_Score> AL;
        private ObservableCollection<QL_Score> QL;
        private ObservableCollection<ScoreStats> MatStatistics;
        private ObservableCollection<ScoreStats> AQLStatistics;
        private ObservableCollection<ScoreStats> ALStatistics;
        private ObservableCollection<ScoreStats> QLStatistics;
        ...
        public IntakeYear GetCurrentIntake()
        {
            using (var context = new CETAPEntities())
            {
                var period = context.IntakeYears.ToList();
        ...
        public static void CompositBDOToCompositDAL(CompositBDO compositBDO, Composit composit)
        {
        ...
        public static void CompositDALToCompositBDO(CompositBDO compositBDO, Composit composit)
        {
            ...
            compositBDO.HomeLanguage = int.TryParse(composit.HomeLanguage, out int homeLang) ? (int?)homeLang : null;
        ...
        private string MapGender(string gender)
        {
            ...
            return gender == "male" ? "1" :
                   gender == "female" ? "2" :
                   null; // or "0" / "U" if you want an "Unknown" fallback
        }
        static void OnlineCompositDBOToOnlineCompositDAL(OnlineComposit composit, OnlineCompositBDO compositBDO)
        {
            composit.RefNo = compositBDO.RefNo;
            composit.Barcode = compositBDO.Barcode;
            composit.Surname = compositBDO.Surname;
            ...
            composit.Citizenship = compositBDO.Citizenship;
            composit.Classification = compositBDO.Classification;
            composit.Gender = HelperUtils.MapGender(compositBDO.Gender);
            composit.DOT = compositBDO.DOT;
            composit.VenueCode = compositBDO.VenueCode;
            composit.VenueName = compositBDO.VenueName;
            composit.HomeLanguage = compositBDO.HomeLanguage.ToString(); // Assuming HomeLanguage is stored as string in OnlineComposit
            composit.GR12Language = compositBDO.GR12Language;
            composit.AQLLanguage = compositBDO.AQLLanguage;
            composit.AQLCode = compositBDO.AQLCode.ToString();
            composit.MatLanguage = compositBDO.MatLanguage;
            composit.MatCode = compositBDO.MatCode.ToString();
            composit.ALScore = compositBDO.ALScore;
            composit.ALLevel = compositBDO.ALLevel;
            composit.QLScore = compositBDO.QLScore;
            composit.QLLevel = compositBDO.QLLevel;
            ...
            composit.Faculty2 = compositBDO.Faculty2;
            composit.Faculty3 = compositBDO.Faculty3;
            composit.Batch = compositBDO.Batch;
            composit.ProvinceID = compositBDO.ProvinceId; // Assuming ProvinceID is part of CompositBDO
            
            composit.DateModified = DateTime.Now; // Example initialization if required
            composit.Description = ""; // Example initialization if required
        }
        static void CompositBDOToOnlineCompositBDO(OnlineCompositBDO OnlinecompositBDO, CompositBDO compositBDO)
        {

            OnlinecompositBDO.RefNo = compositBDO.RefNo;
            OnlinecompositBDO.Barcode = compositBDO.Barcode;
            OnlinecompositBDO.Surname = compositBDO.Surname;
            OnlinecompositBDO.Name = compositBDO.Name;
            OnlinecompositBDO.Initials = compositBDO.Initials;
            OnlinecompositBDO.SAID = compositBDO.SAID;
            OnlinecompositBDO.ForeignID = compositBDO.ForeignID;
            OnlinecompositBDO.DOB = compositBDO.DOB;
            OnlinecompositBDO.ID_Type = compositBDO.ID_Type;
            OnlinecompositBDO.Citizenship = compositBDO.Citizenship;
            OnlinecompositBDO.Classification = compositBDO.Classification;
            OnlinecompositBDO.Gender = compositBDO.Gender;
            OnlinecompositBDO.DOT = compositBDO.DOT;
            OnlinecompositBDO.WroteMat = compositBDO.WroteMat;
            OnlinecompositBDO.WroteAL = compositBDO.WroteAL;
            OnlinecompositBDO.WroteQL = compositBDO.WroteQL;
            OnlinecompositBDO.Faculty = compositBDO.Faculty;
            OnlinecompositBDO.VenueCode = compositBDO.VenueCode;
            OnlinecompositBDO.VenueName = compositBDO.VenueName;
            OnlinecompositBDO.HomeLanguage = compositBDO.HomeLanguage;
            OnlinecompositBDO.GR12Language = compositBDO.GR12Language;
            OnlinecompositBDO.AQLLanguage = compositBDO.AQLLanguage;
            OnlinecompositBDO.MatLanguage = compositBDO.MatLanguage;
            OnlinecompositBDO.AQLCode = compositBDO.AQLCode;
            OnlinecompositBDO.MatCode = compositBDO.MatCode;
            OnlinecompositBDO.ALScore = compositBDO.ALScore;
            OnlinecompositBDO.ALLevel = compositBDO.ALLevel;
            OnlinecompositBDO.QLScore = compositBDO.QLScore;
            OnlinecompositBDO.QLLevel = compositBDO.QLLevel;
            OnlinecompositBDO.MATScore = compositBDO.MATScore;
            OnlinecompositBDO.MATLevel = compositBDO.MATLevel;
            OnlinecompositBDO.Batch = compositBDO.Batch;
            OnlinecompositBDO.Faculty2 = compositBDO.Faculty2;
            OnlinecompositBDO.Faculty3 = compositBDO.Faculty3;
            OnlinecompositBDO.ProvinceId = compositBDO.ProvinceId; // Assuming ProvinceID is part of CompositBDO
            OnlinecompositBDO.DateModified = compositBDO.DateModified;
            OnlinecompositBDO.RowGuid = compositBDO.RowGuid; // Example initialization if required
        ...
        static void OnlineCompositDALToCompositBDO(OnlineCompositBDO compositBDO, OnlineComposit composit)
        {
            ...
            // Safely parse string properties that need to be converted to int?
    compositBDO.HomeLanguage = int.TryParse(composit.HomeLanguage, out int homeLang) ? (int?)homeLang : null;
            compositBDO.AQLCode = int.TryParse(composit.AQLCode, out int aqlCode) ? (int?)aqlCode : null;
            compositBDO.MatCode = int.TryParse(composit.MatCode, out int matCode) ? (int?)matCode : null;
            ...
            compositBDO.Faculty3 = composit.Faculty3;
            compositBDO.Batch = composit.Batch;
            compositBDO.ProvinceId = composit.ProvinceID; // Assuming ProvinceID is part of CompositBDO
            compositBDO.DateModified = composit.DateModified;

            // RowGuid and RowVersion should be set manually if needed, as they do not exist in OnlineComposit
            compositBDO.RowGuid = Guid.NewGuid(); // Example initialization if required
            compositBDO.RowVersion = new byte[8]; // Example initialization if required
        }
    ...
    {'\'', string.Empty }
            ...
            try
            {
                ...
                using (var context = new CETAPEntities())
                {
                    var currentWriters = await context.WriterLists
                     .Where(x => x.DOT >=  intake.yearStart && x.DOT <= intake.yearEnd).ToListAsync();
                    ...
                    var newApplicants = ApplicantsBDO
                                        .Where(x => !inDbWriters.Any(y =>
                                            y.NBT == x.NBT &&
                                            y.DOT == x.DOT 
                                            //&& y.TestLanguage == x.TestLanguage &&
                                            //y.TestType == x.TestType
                                        // Uncomment and fix these lines only if the properties are comparable and non-null
                                        // && y.EMail == x.EMail
                                        // && y.VenueID == x.VenueID
                                        ))
                                        .ToList();

                    var existingApplicants = ApplicantsBDO
                                            .Where(x => inDbWriters.Any(y =>
                                                y.NBT == x.NBT &&
                                                y.DOT == x.DOT
                                            ))
                    ...
                    {
                        logUser = "No new writers to save to Database";
        ...
        public async Task<bool> addComposit(CompositBDO results)
        {
            ...
            using (var context = new CETAPEntities())
            {
                try
                {
                    ...
                    applicantInDB.ProvinceID = results.ProvinceId;
        ...
        public ObservableCollection<AnswerSheetBio> LoadAnswerSheet()
        {
            if (myDir != null)
            {
                ...
                List<ScoreStats> AL = new List<ScoreStats>();
                venues = GetAllvenues();
                // read the excel file.
                ...
                //---------------------------------------
               // ScoreStats AL = new ScoreStats();
               // AL.Records = x.BioDetails.Count();
               //AL.Mean = x.BioDetails.Count() / 2;
               // AL.Add(AL);
               // AnswerSheetBioStatistics = new ObservableCollection<ScoreStats>(AL);
        ...
        public ObservableCollection<AL_Score> LoadALScores()
        {
            if (myDir != null)
            {
                string atype = "AL";
                List<AL_Score> ALs = new List<AL_Score>();

                List<ScoreStats> ALStats = new List<ScoreStats>();
                foreach (var a in myDir.ALScorefiles)
                {
                    string filename = Path.GetFileNameWithoutExtension(a);
                    string testLanguage = "";
                    string testDomain = "";
                    ...
                    // Requires Statistics of Excel sheet here
                    //---------------------------------------
                    var ALread = readfile.ALScores;
                    var ALreads = ALread.GroupBy(e => e.ID).Select(gp => gp.First()).ToList();
                    List<int> myAL = new List<int>();
                    foreach (var x in ALreads)
                    {
                        x.TestCode = testCode;
                        x.Language = testLanguage;
                        myAL.Add((int)x.AL);
                    ...
                    //-----------------------------------------
                    ALs.AddRange(ALreads);
                    ALStats.Add(Alstat);

                }
                // AQLStats = AQLStats.GroupBy(x => x.Filename).ToList();
                //List<ScoreStats> mydata = AQLStats.GroupBy(x => x.Filename).ToList();
                ALStatistics = new ObservableCollection<ScoreStats>(ALStats);
                AL = new ObservableCollection<AL_Score>(ALs);
                return AL;
            }
            else return null;
        }

        public ObservableCollection<QL_Score> LoadQLScores()
        {
            if (myDir != null)
            {
                string atype = "QL";
                List<QL_Score> QLs = new List<QL_Score>();

                List<ScoreStats> QLStats = new List<ScoreStats>();
                foreach (var a in myDir.QLScorefiles)
                {
                    string filename = Path.GetFileNameWithoutExtension(a);
                    string testLanguage = "";
                    string testDomain = "";
                  ...
                  //  string[] mysection = test.Split('_');
                    ...
                    // Requires Statistics of Excel sheet here
                    //---------------------------------------
                    var QLread = readfile.QLScores;
                    var QLreads = QLread.GroupBy(e => e.ID).Select(gp => gp.First()).ToList();
                    List<int> myQL = new List<int>();
                    foreach (var x in QLreads)
                    {
                        x.TestCode = testCode;
                        x.Language = testLanguage;
                        myQL.Add((int)x.QL);
                    ...
                    //-----------------------------------------
                    QLs.AddRange(QLreads);
                    QLStats.Add(Qlstat);

                }
                // AQLStats = AQLStats.GroupBy(x => x.Filename).ToList();
                //List<ScoreStats> mydata = AQLStats.GroupBy(x => x.Filename).ToList();
                QLStatistics = new ObservableCollection<ScoreStats>(QLStats);
                QL = new ObservableCollection<QL_Score>(QLs);
                return QL;
            }
            else return null;
        }
        ...
        public ObservableCollection<CompositBDO> MatchScores()
        {
            ...
            var matched = (from b in BIO
                           join a in AL on b.Barcode equals a.ID into ab_j
                           join q in QL on b.Barcode equals q.ID into aq_j
                           join m in MAT on b.Barcode equals m.ID into bm_j
                           join c in venues on b.VenueCode equals c.VenueCode into venue_j
                           from ab in ab_j.DefaultIfEmpty(new AL_Score())
                           from aq in aq_j.DefaultIfEmpty(new QL_Score())
                           ...
                           select new
                           {
                               ...
                               QL = aq.QL == 0 ? (int?)null : aq.QL,
                               wroteQL = aq.QL == null ? "NO" :
                                          aq.QL == 0 ? "NO" : "YES",
                               QL_Level = aq.QL >= degbenchmark.QL_PU ? "Proficient Upper" :
                                          aq.QL >= degbenchmark.QL_PL ? "Proficient Lower" :
                                          aq.QL >= degbenchmark.QL_IU ? "Intermediate Upper" :
                                          aq.QL >= degbenchmark.QL_IL ? "Intermediate Lower" :
                                          aq.QL >= degbenchmark.QL_BU ? "Basic Upper" :
                                          aq.QL > degbenchmark.QL_BL ? "Basic Lower" : "",
            ...
            try
            {
                foreach (var x in matched)
                {
                    ...
                    record.Barcode = x.Barcode;
                    record.RefNo = x.NBT;
                    record.Surname = x.Surname.Trim();
                    record.Name = x.Name.Trim();
                    record.Initials = x.Initials;
                    record.SAID = (x.SAID == null || x.SAID == "") ? (long?)null : Convert.ToInt64(x.SAID);
                    record.ForeignID = x.ForeignID;
                    record.ID_Type = x.ID_Type.ToString();
        ...
        public ObservableCollection<OnlineCompositBDO> DBOnlineScores(DateTime testDate)
        {
            ...
            using (var context = new CETAPEntities())
            {
                ...
                var comp = context.OnlineComposits
                              .Where(c => c.Batch != "Invalid" && c.Batch != "Blocked" && c.DOT == testDate)
                              .Select(c => c)
                              .ToList();
        ...
        public bool GenerateExcelCompositeForOnline()
        {
            ...
            if(OnlineComposite.Count > 0)
            {
                ...
                foreach (var rec in UCT)
                {
                    ...
                    UctRec.ForeignID = rec.Foreign_Passport.Trim();
                    UctRec.Initials = rec.Initials.Trim();
                    UctRec.MATLevel = rec.MathsPerformanceLevel;
                    UctRec.MATScore = rec.MathsScore;
                    UctRec.Name = rec.First_Name.Trim();
                    ...
                    UctRec.Surname = rec.Surname.Trim();
        ...
        //    ObservableCollection<VenueBDO> venues = new ObservableCollection<VenueBDO>();
            ...
            var the_scores = (from al in AL
                              join ql in QL on al.ID equals ql.ID into qlGroup
                              from ql in qlGroup.DefaultIfEmpty()

                              join mat in MAT on al.ID equals mat.ID into matGroup
                              from mat in matGroup.DefaultIfEmpty() 
                              select new
                              {
                                  Barcode = al.ID,
                                  AQL_Language = al.Language,
                                  AQLCode = al.TestCode,
                                  Mat_Language = mat != null ? mat.Language: null,
                                  MatCode = mat != null ? mat.TestCode : null,

                                  WroteAL = (al.AL.HasValue && al.AL.Value > 0) ? "YES" : "NO",
                                  WroteQL = (ql != null && ql.QL.HasValue && ql.QL.Value > 0) ? "YES" : "NO",
                                  WroteMAT = (mat != null && mat.MAT.HasValue && mat.MAT.Value > 0) ? "YES" : "NO",

                                  ALScore = al.AL.HasValue ? al.AL.Value : (int?)null,
                                  AL_Level = al.AL.HasValue
                                        ? (al.AL.Value >= degbenchmark.AL_PU ? "Proficient Upper" :
                                           al.AL.Value >= degbenchmark.AL_PL ? "Proficient Lower" :
                                           al.AL.Value >= degbenchmark.AL_IU ? "Intermediate Upper" :
                                           al.AL.Value >= degbenchmark.AL_IL ? "Intermediate Lower" :
                                           al.AL.Value >= degbenchmark.AL_BU ? "Basic Upper" :
                                           al.AL.Value > degbenchmark.AL_BL ? "Basic Lower" : "")
                                        : "",

                                  QLScore = (ql != null && ql.QL.HasValue)? ql.QL.Value : (int?)null,
                                  QL_Level = (ql != null && ql.QL.HasValue)
                                        ? (ql.QL.Value >= degbenchmark.QL_PU ? "Proficient Upper" :
                                           ql.QL.Value >= degbenchmark.QL_PL ? "Proficient Lower" :
                                           ql.QL.Value >= degbenchmark.QL_IU ? "Intermediate Upper" :
                                           ql.QL.Value >= degbenchmark.QL_IL ? "Intermediate Lower" :
                                           ql.QL.Value >= degbenchmark.QL_BU ? "Basic Upper" :
                                           ql.QL.Value > degbenchmark.QL_BL ? "Basic Lower" : "")
                                        : "",

                                  MATScore = (mat != null && mat.MAT.HasValue) ? mat.MAT.Value : (int?)null,
                                  Mat_Level = (mat != null && mat.MAT.HasValue)
                                        ? (mat.MAT.Value >= degbenchmark.MAT_PU ? "Proficient Upper" :
                                           mat.MAT.Value >= degbenchmark.MAT_PL ? "Proficient Lower" :
                                           mat.MAT.Value >= degbenchmark.MAT_IU ? "Intermediate Upper" :
                                           mat.MAT.Value >= degbenchmark.MAT_IL ? "Intermediate Lower" :
                                           mat.MAT.Value >= degbenchmark.MAT_BU ? "Basic Upper" :
                                           mat.MAT.Value > degbenchmark.MAT_BL ? "Basic Lower" : "")
                                        : ""
                              }).ToList();

            var alNotInBio = AL
                .Where(al => !BIO.Any(b => b.Barcode == al.ID))
                .ToList();

            var bioNotInWriters = BIO
                .Where(b => !writers.Any(w => w.NBT == b.NBT))
                .ToList();

            var the_Bio = (
                            from bioEntry in BIO
                            join writer in writers on bioEntry.NBT equals writer.NBT into BioGroup
                            from writer in BioGroup.DefaultIfEmpty()

                            //join venue in venues on bioEntry.VenueCode equals venue.VenueCode into VenueGroup
                            //from venue in VenueGroup.DefaultIfEmpty()

                          //  where al != null && al.AL.HasValue && al.AL.Value > 0
                                select new
                                {
                                    Barcode = bioEntry.Barcode,
                                    NBT = writer.NBT,
                                    Surname = writer != null ? writer.Surname : bioEntry.Surname,
                                    Name = writer != null ? writer.Name : bioEntry.Name,
                                    Initials = writer != null ? writer.Initials : bioEntry.Initials,
                                    SAID = writer != null ? writer.SAID : (long?)null,
                                    ForeignID = writer != null ? writer.ForeignID : "",
                                    ID_Type = bioEntry.ID_Type,
                                    Gender = writer != null ? writer.Gender : "",
                                    DOB = writer != null ? writer.DOB : DateTime.MinValue,
                                    Citizenship = bioEntry.Citizenship,
                                    Classification = bioEntry.Classification,
                                    Province = bioEntry != null ? bioEntry.ProvinceCode: null,
                                    VenueCode = 99999,
                                    VenueName = "@ NBT Online",
                                    DOT = writer != null ? writer.DOT : DateTime.MinValue,
                                    HomeLanguage = bioEntry.HomeLanguage,
                                    GR12Language = bioEntry.Grade12_Language,
                                    Faculty1 = bioEntry.Faculty1,
                                    Faculty2 = bioEntry.Faculty2,
                                    Faculty3 = bioEntry.faculty3,  
                                    Batch = ""
                                }).ToList();


            var the_list= (from y in the_scores
                           join t in the_Bio on y.Barcode equals t.Barcode into BioGroup
                           from t in BioGroup.DefaultIfEmpty()
                           where y != null && y.ALScore.HasValue && y.ALScore.Value > 0
                           select new
                           {
                             y,
                             t
            ...
            try
            {
                foreach (var x in the_list)
                {
                    CompositBDO record = new CompositBDO();
                    record.Barcode = x.y.Barcode;
                    record.RefNo = x.t.NBT;
                    record.Surname = x.t.Surname;
                    record.Name = x.t.Name;
                    record.Initials = x.t.Initials;
                    record.SAID = (x.t.SAID == null) ? (long?)null : Convert.ToInt64(x.t.SAID);
                    record.ForeignID = x.t.ForeignID;
                    record.ID_Type = x.t.ID_Type.ToString();
                    record.Gender = x.t.Gender;
                    record.DOB = x.t.DOB;

                    record.HomeLanguage = x.t.HomeLanguage;
                    record.GR12Language = x.t.GR12Language;
                    record.Citizenship = x.t.Citizenship;
                    record.Classification = x.t.Classification;

                    record.ALScore = x.y.ALScore;
                    record.QLScore = x.y.QLScore;
                    record.MATScore = x.y.MATScore;
                    record.ALLevel = x.y.AL_Level;
                    record.QLLevel = x.y.QL_Level;
                    record.MATLevel = x.y.Mat_Level;
                    record.WroteAL = x.y.WroteAL;
                    record.WroteQL = x.y.WroteQL;
                    record.WroteMat = x.y.WroteMAT;
                    record.DOT = x.t.DOT;
                    record.VenueCode = x.t.VenueCode;
                    record.VenueName = x.t.VenueName;
                    record.AQLCode = x.y.AQLCode;
                    record.MatCode = x.y.MatCode;
                    record.AQLLanguage = x.y.AQL_Language;
                    record.MatLanguage = x.y.Mat_Language;
                    record.Faculty = x.t.Faculty1;
                    record.Faculty2 = x.t.Faculty2;
                    record.Faculty3 = x.t.Faculty3;
                    record.Batch = x.t.Batch;
                    record.ProvinceId = x.t.Province; 
                    record.RowGuid = Guid.NewGuid();
                    record.DateModified = DateTime.Now;
        ...
        public bool GenerateCompositeForSessionPnP()
        {
            bool session = false;
            ...
            var Compo = from C in Composite
                        select new
                        {
                            ...
                            Barcode = C.Barcode,
                            Name = C.Name,
                            DOB = String.Format("{0:yyyyMMdd}", C.DOB),
                            IDType = C.ID_Type,
                            Citizenship = C.Citizenship,
                            Classification = C.Classification,
                            Gender = C.Gender,
                            faculty1 = HelperUtils.GetFacultyName(C.Faculty),
                            Testdate = String.Format("{0:yyyyMMdd}", C.DOT),
                            VenueCode = C.VenueCode.ToString("D5"),
                            VenueName = C.VenueName,
                            Hlanguage = C.HomeLanguage,
                            G12L = C.GR12Language,
                            AQLLang = C.AQLLanguage,
                            AQLCode = C.AQLCode,
                            MatLang = C.MatLanguage,
                            MatCode = C.MatCode,
                            Faculty2 = HelperUtils.GetFacultyName(C.Faculty2),
                            Faculty3 = HelperUtils.GetFacultyName(C.Faculty3),

                            Birth = String.Format("{0:dd/MM/yyyy}", C.DOB),
                            W_AL = C.WroteAL,
                            W_QL = C.WroteQL,
                            W_Mat = C.WroteMat,
                            StNo = "",
                            Faculty = "",
                            Programme = "",
                            DateTest = String.Format("{0:yyyyMMdd}", C.DOT),
                            Venue = C.VenueName,
                            Sex = C.Gender,
                            street1 = "",
                            street2 = "",
                            ...
                            AQL_Lang = C.AQLLanguage,
                            Mat_Lang = C.MatLanguage,
                            ALScore = C.ALScore,
                            ALLevel = C.ALLevel,
                            QLScore = C.QLScore,
                            QLLevel = C.QLLevel,
            ...
            foreach (var rec in UCT)
            {
                ...
                UctRec.QLLevel = rec.QLPerformanceLevel;
                UctRec.QLScore = rec.QLScore;
                UctRec.SAID = rec.South_African_ID_No.HasValue ? rec.South_African_ID_No.Value.ToString("D13") : string.Empty;
            ...
            #region ForWebUploads

            var NBTWeb = from Adata in Compo
                         ...
                         select new
                         {
                             ...
                             Initial = Adata.Initials,
                             SAID = Adata.SAID,
                             Passport = Adata.Passport,
                             DOB = String.Format("{0:dd/MM/yyyy}", Adata.DOB),
                             ID_Type = Adata.IDType,
                             Citizenship = Adata.Citizenship,
                             Classification = Adata.Classification,
                             Gender = Adata.Gender,
                             Faculty = Adata.Faculty,
                             Date_of_Test = String.Format("{0:yyyyMMdd}", Adata.DateTest),
                             VenueCode = Adata.VenueCode,
                             VenueName = GetWebSiteNameByVenueCode(Convert.ToInt32(Adata.VenueCode)),
                             HLanguage = Adata.Hlanguage,
                             GLanguage = Adata.G12L,
                             AQLLanguage = Adata.AQLLang,
                             AQLCode = Adata.AQLCode,
                             MATLanguage = Adata.MatLang,
                             MatCode = Adata.MatCode,
                             ALScore = Adata.ALScore,
                             ALLevel = Adata.ALLevel,
                             QLScore = Adata.QLScore,
                             QLLevel = Adata.QLLevel,
                             MatScore = Adata.MatScore,
                             MatLevel = Adata.MatLevel,
                             WroteAL = Adata.W_AL,
                             WroteQL = Adata.W_QL,
                             WroteMAT = Adata.W_Mat,
                             Faculty2 = Adata.Faculty2,
                             Faculty3 = Adata.Faculty3,
                             I_Barcode = Adata.Barcode,
                             TName = Adata.AQLCode,
        ...
        public bool GenerateCompositeForSession()
        {
            bool session = false;
            string resultpath = Path.Combine(ApplicationSettings.Default.FilesForScoring, "Composit_draft.csv");
            ...
            // write to database OnlineComposite table
            ObservableCollection<OnlineCompositBDO> OnlineRecs = new ObservableCollection<OnlineCompositBDO>();
            foreach (var rec in Composite)
            {
                OnlineCompositBDO Onrec = new OnlineCompositBDO();
                CompositBDOToOnlineCompositBDO(Onrec, rec);
                OnlineRecs.Add(Onrec);
            }
            int recCount = 0;
            using (var context = new CETAPEntities())
            {
                foreach (var Orec in OnlineRecs)
                {
                    OnlineComposit record = new OnlineComposit();
                    OnlineCompositDBOToOnlineCompositDAL(record, Orec);
                    context.OnlineComposits.Add(record);
                    recCount++;
                    if (recCount % 200 == 0)
                    {
                        try
        ...
        private bool GenerateExcelComposite(string directory)
        {
            ...
            string intake = ApplicationSettings.Default.IntakeYear.ToString();
            string writerListFileName = intake + " Intake Cycle writerlist";
            if (AllScores.Count > 0)
            {
                ...
                ws1.Range("O1:Z1").Style.Fill.BackgroundColor = XLColor.GreenYellow;
                ws1.Range("AA1:AF1").Style.Fill.BackgroundColor = XLColor.LightGray;
                ws1.Range("AG1:AH1").Style.Fill.BackgroundColor = XLColor.Yellow;
                var Row11 = ws1.Row(1);

                Row11.Height = 30;
                Row11.Style.Font.Bold = true;
                Row11.Style.Font.FontSize = 9;
                ...
                ws1.Cell(1, 4).Value = "First Name";
                ws1.Cell(1, 5).Value = "Middle Initials";
                ws1.Cell(1, 6).Value = "South African ID";
                ws1.Cell(1, 7).Value = "Foreign ID";
                ws1.Cell(1, 8).Value = "Date of Birth";
                ws1.Cell(1, 9).Value = "Wrote AL";
                ws1.Cell(1, 10).Value = "Wrote QL";
                ws1.Cell(1, 11).Value = "Wrote Maths";
                ws1.Cell(1, 12).Value = "Student Number";
                ws1.Cell(1, 13).Value = "Faculty";
                ws1.Cell(1, 14).Value = "Programme";
                ws1.Cell(1, 15).Value = "Date_of_Test";
                ws1.Cell(1, 16).Value = "Venue";
                ws1.Cell(1, 17).Value = "Gender";
                ws1.Cell(1, 18).Value = "Street and Number";
                ws1.Cell(1, 19).Value = "Street Name";
                ws1.Cell(1, 20).Value = "Suburb";
                ws1.Cell(1, 21).Value = "City/Town";
                ws1.Cell(1, 22).Value = "Province/Region";
                ws1.Cell(1, 23).Value = "Postal Code";
                ws1.Cell(1, 24).Value = "e-mail Address";
                ws1.Cell(1, 25).Value = "Landline Number";
                ws1.Cell(1, 26).Value = "Mobile Number";
                ws1.Cell(1, 27).Value = "AL Score";
                ws1.Cell(1, 28).Value = "AL Performance";
                ...
                ws1.Cell(2, 1).Value = writerlist1.AsEnumerable();
        ...
        public ObservableCollection<AL_Score> GetAL()
        {
            LoadALScores();
            return AL;
        }
        public ObservableCollection<QL_Score> GetQL()
        {
            LoadQLScores();
            return QL;
        }
        ...
        public bool WriteQAdataToDB(datFileAttributes filename)
        {
            ...
            if (ApplicationSettings.Default.DBAvailable)
            {
                ...
                using (var context = new CETAPEntities())
                {
                    ...
                    if (batchrec != null)
                    {
                        System.Windows.MessageBox.Show("Use update for the file as it exists in DataBase", "File: " + filename.SName, MessageBoxButton.OK);
                        return completed;
                    }
                }
                ...
                switch (filename.CSX)
                {
                    case 909:
                        ...
                        catch (FileHelpers.BadUsageException ex)
                        {
                            ...
                            System.Windows.MessageBox.Show(ex.Message, "File: " + filename.SName, MessageBoxButton.OK, MessageBoxImage.Error);
                        }
                        catch (Exception ex)
                        {
        ...
        public QADatRecord GetNBTNumberFromDBbyFID(QADatRecord SelectedRecord)
        {
            ...
            using (var context = new CETAPEntities())
            {
                WriterList WriterInDB = context.WriterLists.Where(x => x.ForeignID == SelectedRecord.ForeignID.Trim() && !string.IsNullOrWhiteSpace(SelectedRecord.ForeignID)).FirstOrDefault();
                if (WriterInDB != null)
                {
                    SelectedRecord.Reference = WriterInDB.NBT.ToString();
                }
        ...
        public QADatRecord GetNewNBTNumberFromDB (QADatRecord SelectedRecord)
        {
                        ...
                        switch (area)
                        {
                            case "Reference":
                                ...
                                if (!InDB)
                                {
                                    ...
                                    if (myNBT != null)
                                    {
                                        Int64 OldNBT = Convert.ToInt64(toCleanRecord.Reference);
                                        myNBT.OriginalNBT = OldNBT;

                                        //replace the wrong NBT with the new one from the database
                                        toCleanRecord.Reference = myNBT.NewNBT.ToString();
                                    }
                                    using (var context = new CETAPEntities())
                                    {
                                        var ID = myNBT.NewNBT;
                                        ...
                                        if (nbtInDB != null)
                                        {
                                            ...
                                            // No Attach, No State change needed
                                            context.SaveChanges();
                            ...
                            case "Section1":
                                foreach (DatAnswer a in toCleanRecord.Section1)
                                {
                                    ...
                                    if (toCleanRecord.DatFile.TestCode == "0106" || toCleanRecord.DatFile.TestCode == "0116") n = " ";
