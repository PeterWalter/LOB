...
namespace CETAP_LOB.Model.scoring
{
  public class AnswerSheetBio : ModelBase
  {
    ...
    public const string ProvinceCodePropertyName = "ProvinceCode";
    ...
    public string matTestname
    {
      ...
      set
      {
        ...
        public int? ProvinceCode
        {
            ...
            set
            {
                               int? provinceCode = _provinceCode;
                int? nullable = value;
                if ((provinceCode.GetValueOrDefault() != nullable.GetValueOrDefault() ? 0 : (provinceCode.HasValue == nullable.HasValue ? 1 : 0)) != 0)
                    return;
                _provinceCode = value;
